<template>
	<view class="allwenda">
		...
		<view class="wen_list">
			...
			<bottom :remark="remark" :point="103" :title="'预约看房'" :pid="parseInt(project_id)" :telphone="telphone">
			</bottom>
		</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			getdata(id) {
				...
				if (id&&id!=0) {
				uni.request({
					url: that.javatest + "/applets/jy/questions",
					data: {
						page: page,
						limit: "10",
					...
					uni.request({
						url: that.javatest + "/applets/jy/city/questions",
						data: {
							page: page,
							limit: "10",
